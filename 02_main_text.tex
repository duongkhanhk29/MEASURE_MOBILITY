...
\begin{figure}[!ht]
    \centering
    \scalebox{0.55}{\includesvg{figs/compare1.svg}}
...
\begin{figure}[!ht]
    \centering
    \scalebox{0.55}{\includesvg{figs/compare2.svg}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.55}{\includesvg{figs/VNM_USA.svg}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.5}{\includesvg{figs/abs_rel.svg}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.49}{\includesvg{figs/rank.svg}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.55}{\includesvg{figs/map.svg}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.55}{\includesvg{figs/compare3.svg}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.5}{\includesvg{figs/abs_pro.svg}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.5}{\includesvg{figs/rel_pro.svg}}
