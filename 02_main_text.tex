...
\begin{figure}[!ht]
    \centering
    \scalebox{0.55}{\includegraphics{figs/compare1.pdf}}
...
\begin{figure}[!ht]
    \centering
    \scalebox{0.55}{\includegraphics{figs/compare2.pdf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.55}{\includegraphics{figs/VNM_USA.pdf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.5}{\includegraphics{figs/abs_rel.pdf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.49}{\includegraphics{figs/rank.pdf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.55}{\includegraphics{figs/map.pdf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.55}{\includegraphics{figs/compare3.pdf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.5}{\includegraphics{figs/abs_pro.pdf}}
...
\begin{figure}[H]
    \centering
    \scalebox{0.5}{\includegraphics{figs/rel_pro.pdf}}
